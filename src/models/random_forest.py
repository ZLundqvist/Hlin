...
class RandomForestModel:
    ...
    def prepare_data(self, data_set: pd.DataFrame):
        # train_df, test_df = train_test_split(data_set, train_size=0.80, random_state=42, stratify=data_set['label'].values) # Stratify data
        train_df, test_df = train_test_split(data_set, train_size=0.80, random_state=42)
